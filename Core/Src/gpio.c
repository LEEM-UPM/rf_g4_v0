...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, SX1262_RESET_Pin|SX1262_CS_Pin|SX1262_LNA_EN_Pin|SX1280_DIO1_Pin
                          |FDCAN1_STB_Pin|FDCAN2_STB_Pin|SX1280_DIO2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SX1280_RESET_Pin|SX1280_CS_Pin|SX1280_LNA_EN_Pin|SX1280_DIO3_Pin
                          |LED_Pin|SX1262_SW_CTRL_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = SX1262_RESET_Pin|SX1262_CS_Pin|SX1262_LNA_EN_Pin|SX1280_DIO1_Pin
                          |FDCAN1_STB_Pin|FDCAN2_STB_Pin|SX1280_DIO2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : SX1280_RESET_Pin SX1280_CS_Pin SX1280_LNA_EN_Pin SX1280_DIO3_Pin
                           LED_Pin SX1262_SW_CTRL_Pin */
  GPIO_InitStruct.Pin = SX1280_RESET_Pin|SX1280_CS_Pin|SX1280_LNA_EN_Pin|SX1280_DIO3_Pin
                          |LED_Pin|SX1262_SW_CTRL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
